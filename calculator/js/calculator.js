...
const Calculator = {
    //this will dispaly 0 on the calc screen
    Display_Value: '0',
    //this will hold the first operand for any expressioin, we set it to null for now.
    First_Operand: null,
...
function Handle_Operator(Next_Operator) {
    ...
    //Calcualtor.First_Operand if it doesn't already exist.
    const Value_of_Input = parseFloat(Display_Value);
    //checks if an operator an already exist and if Wait_Second_Operand is true,
    ...
    if (First_Operand == null) {
        ...
        //in ther Perform_Calculation object and the function that matches the
        //operator is executed
        let result = Perform_Calculation[operator](Value_Now, Value_of_Input);
        //here we add a fixed amount of numbers afger the decimal.
